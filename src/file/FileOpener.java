...
public class FileOpener {
		...
		try {
			...
			while (lineScanner.hasNextLine()) {
				...
				if (edgeScanner.hasNext()) {
					...
					Vertex v1 = retModel.getNumber(Integer.parseInt(endPoints[0]));
					Vertex v2 = retModel.getNumber(Integer.parseInt(endPoints[1]));
	...
	public static void writeModel(String fileName, Model model) {
